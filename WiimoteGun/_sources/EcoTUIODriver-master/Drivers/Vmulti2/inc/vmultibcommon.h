#if !defined(_vmultib_COMMON_H_)
#define _vmultib_COMMON_H_

//
//These are the device attributes returned by vmultib in response
// to IOCTL_HID_GET_DEVICE_ATTRIBUTES.
//

#define vmultib_PID              0xBA2C
#define vmultib_VID              0x002F
#define vmultib_VERSION          0x0001
...
#pragma pack(1)
typedef struct _vmultib_CONTROL_REPORT_HEADER
{
...
#pragma pack(1)
typedef struct _vmultib_KEYBOARD_REPORT
{
...
} vmultibKeyboardReport;

typedef struct _vmultib_KEYBOARD_OUTPUT_REPORT
{
    // Num Lock, Caps Lock, Scroll Lock, Compose, Kana
    BYTE      LedFlags;
} vmultibKeyboardOutputReport;
...
#pragma pack(1)
typedef struct _vmultib_JOYSTICK_REPORT
{
...
#pragma pack(1)
typedef struct _vmultib_DIGI_REPORT
{
...
#pragma pack(1)
typedef struct _vmultib_MOUSE_REPORT
{
...
#pragma pack(1)
typedef struct _vmultib_RELATIVE_MOUSE_REPORT
{
...
typedef struct _vmultib_MULTITOUCH_REPORT
{
...
#pragma pack(1)
typedef struct _vmultib_FEATURE_REPORT
{
...
} vmultibFeatureReport;

typedef struct _vmultib_MAXCOUNT_REPORT
{
...
#pragma pack(1)
typedef struct _vmultib_MESSAGE_REPORT
{
