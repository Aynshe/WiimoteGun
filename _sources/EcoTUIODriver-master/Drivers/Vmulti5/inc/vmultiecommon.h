#if !defined(_vmultie_COMMON_H_)
#define _vmultie_COMMON_H_

//
//These are the device attributes returned by vmultie in response
// to IOCTL_HID_GET_DEVICE_ATTRIBUTES.
//

#define vmultie_PID              0xBA5C
#define vmultie_VID              0x005F
#define vmultie_VERSION          0x0001
...
#pragma pack(1)
typedef struct _vmultie_CONTROL_REPORT_HEADER
{
...
#pragma pack(1)
typedef struct _vmultie_KEYBOARD_REPORT
{
...
} vmultieKeyboardReport;

typedef struct _vmultie_KEYBOARD_OUTPUT_REPORT
{
    // Num Lock, Caps Lock, Scroll Lock, Compose, Kana
    BYTE      LedFlags;
} vmultieKeyboardOutputReport;
...
#pragma pack(1)
typedef struct _vmultie_JOYSTICK_REPORT
{
...
#pragma pack(1)
typedef struct _vmultie_DIGI_REPORT
{
...
#pragma pack(1)
typedef struct _vmultie_MOUSE_REPORT
{
...
#pragma pack(1)
typedef struct _vmultie_RELATIVE_MOUSE_REPORT
{
...
typedef struct _vmultie_MULTITOUCH_REPORT
{
...
#pragma pack(1)
typedef struct _vmultie_FEATURE_REPORT
{
...
} vmultieFeatureReport;

typedef struct _vmultie_MAXCOUNT_REPORT
{
...
#pragma pack(1)
typedef struct _vmultie_MESSAGE_REPORT
{
